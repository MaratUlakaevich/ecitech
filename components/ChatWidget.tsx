          ...
          <div className="w-full h-full flex items-center justify-center relative">
            ...
            >
              <path
                fill-rule="evenodd"
                clip-rule="evenodd"
                d="M2.813 5.375c0-.897.727-1.625 1.624-1.625h21.125c.898 0 1.625.728 1.625 1.625v15.593c0 .897-.727 1.625-1.625 1.625H9.745l-5.612 4.479a.813.813 0 01-1.32-.635V5.375zm2.759 1.067v16.003L8.759 19.9h15.67V6.441H5.571z"
                fill="#fff"
              ></path>
              <path
                fill="#fff"
                d="M7.965 12.979h9.141v2.344H7.965zM7.965 8.828h13.203v2.344H7.965z"
              ></path>
            </svg>
          </div>
        </button>
